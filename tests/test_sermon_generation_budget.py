from app.services.sermon_service import _continuation_max_tokens, _resize_max_tokens, _sermon_max_tokens, _should_auto_resize
...
def test_generation_budget_scales_but_has_safe_bounds():
    ...
    assert _sermon_max_tokens(15, "qwen/qwen3-4b") == 3000
    assert _sermon_max_tokens(30, "qwen/qwen3-8b") == 3072
...
def test_qwen3_continuation_budget_is_bounded():
    assert _continuation_max_tokens(15) == 1500
    assert _continuation_max_tokens(30) == 1536
